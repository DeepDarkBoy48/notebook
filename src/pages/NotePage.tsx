      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <article className="max-w-3xl mx-auto w-full space-y-12">
          ...
          <div className="prose prose-base md:prose-lg prose-gray max-w-none 
            ...
            prose-h1:text-2xl md:prose-h1:text-3xl prose-h1:mt-24 prose-h1:mb-10
            prose-h2:text-xl md:prose-h2:text-2xl prose-h2:mt-16 prose-h2:mb-8 prose-h2:decoration-pink-500 prose-h2:underline prose-h2:decoration-4 prose-h2:underline-offset-4
            prose-h3:text-lg md:prose-h3:text-xl prose-h3:mt-12 prose-h3:mb-6
