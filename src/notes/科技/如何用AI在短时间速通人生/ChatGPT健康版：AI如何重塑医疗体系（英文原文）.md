---
title: ChatGPT健康版：AI如何重塑医疗体系（英文原文）
date: 2026/01/17
...
isPublic: 1
---
# ChatGPT健康版：AI如何重塑医疗体系（英文原文）

Healthcare isn’t working for patients or doctors, but AI tools can help.
**Author:** [Fidji Simo](https://substack.com/@fidjisimo)
**Date:** Jan 07, 2026
**Source:** [Fidji Simo&#39;s Substack](https://fidjisimo.substack.com/p/chatgpt-health)

---

![Cover Image](https://img.nanopixel.uk/cdn-cgi/image/format=webp,quality=85/https://img.nanopixel.uk/picgo/3f4273f54926c3de7abb07fe8333d1aa.png)
...
My experience exemplified why I believe so strongly in AI’s potential for health. [62% of Americans](https://cdn.openai.com/pdf/2cb29276-68cd-4ec6-a5f4-c01c5e7a36e9/OpenAI-AI-as-a-Healthcare-Ally-Jan-2026.pdf) say our healthcare system is broken, and [nearly half of U.S. physicians](https://www.ama-assn.org/practice-management/physician-health/what-physician-burnout) reported at least one symptom of burnout last year. The healthcare system clearly isn’t working for patients or doctors, which is why both are turning to AI tools for help, and why we built [ChatGPT Health](https://openai.com/index/introducing-chatgpt-health/) to support people even further.

According to the [American Medical Association](https://www.ama-assn.org/system/files/physician-ai-sentiment-report.pdf), physicians’ use of AI nearly doubled from 2023 to 2024, and 68% say AI gives them an advantage in being able to care for their patients. In a separate [survey](https://cdn.openai.com/pdf/2cb29276-68cd-4ec6-a5f4-c01c5e7a36e9/OpenAI-AI-as-a-Healthcare-Ally-Jan-2026.pdf) we commissioned, 3 in 5 US adults used AI tools for their health or healthcare over the past 3 months, and 75% of those who did found it very or extremely helpful.
...
Clinicians today have heavier caseloads and more administrative burden, which means less time with patients and even less time to keep up with the latest research. Under these conditions, it’s almost impossible for doctors to look beyond the immediate problem in front of them and see the full picture of someone’s health. That lack of context often means treating individual symptoms in isolation, rather than addressing the underlying drivers. This becomes an even greater challenge [as more people live with multiple conditions at once](https://www.cdc.gov/pcd/issues/2025/24_0539.htm?utm_source=chatgpt.com), and many of these conditions sit at the intersection of genetics, environment, and lifestyle.

AI doesn’t have these constraints, which is why we see clinicians turning to AI tools to [improve productivity](https://openai.com/solutions/healthcare/) on administrative tasks like note-taking, as well as support their clinical reasoning and serve as a second set of eyes to [reduce diagnostic errors](https://openai.com/index/ai-clinical-copilot-penda-health/). AI systems are particularly good at synthesizing large amounts of information, which makes them well suited to helping doctors consider full medical histories, overlapping conditions, medications, and risk factors all together. AI can also help them draw on a growing body of medical research that no doctor can realistically track on their own when there are thousands of papers published every week.

In addition to supporting clinicians, AI can help make medical information more understandable for patients. Time constraints and language barriers mean doctors can’t always fully explain what they’re seeing and why they’re recommending a particular course of treatment. This is part of why [9 out of 10 U.S. adults](https://www.cdc.gov/health-literacy/php/about/tell-others.html) say they can’t understand and use their own health information. But AI can translate that information into plain language and has infinite time for follow-up questions and explaining in a way that matches however you learn best.
...
![ChatGPT Health Interface](https://img.nanopixel.uk/cdn-cgi/image/format=webp,quality=85/https://img.nanopixel.uk/picgo/14af3b22527b78b8c1abc62f4129ec50.png)

ChatGPT Health is another step toward turning ChatGPT into a personal super-assistant that can support you with information and tools to achieve your goals across any part of your life. We’re still at the very beginning of this journey, but I’m excited to get these tools into more people’s hands. You can sign up to [request access to ChatGPT Health here](https://chatgpt.com/health/waitlist). You can also read our [blog post](https://openai.com/index/introducing-chatgpt-health/) for more information about how ChatGPT Health works and how we developed it with strong privacy protections and input from physicians.
